...
module.exports = {
  mode: 'development',
  entry: {
    pageA: path.resolve(__dirname, 'src/result-analysis', 'pageA'),
    pageB: path.resolve(__dirname, 'src/result-analysis', 'pageB'),
    // vendor: ['lodash']
  },
  output: {
    path: path.resolve(__dirname, 'dist/result-analysis'),
    filename: '[name].bundle.js',
    chunkFilename: '[name].chunk.js',
    publicPath: './../../dist/result-analysis/',
  },
  module: {
    rules: [
      {
